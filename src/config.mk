...
CFLAGS   = -std=c99 -march=native -ftree-vectorize -fopenmp -pipe -static -funroll-loops -flto -ffast-math -O3 -Os -pedantic -Wall -Wno-unused-function -Wno-deprecated-declarations ${INCS} ${CPPFLAGS}
